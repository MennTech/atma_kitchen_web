...
const CreateAtmaProdukPage = () => {
    ...
    const getAllResep = async () => {
        setIsLoading(true);
        try {
            const response = await GetAllResep();
    ...
    const handleSubmit = async (event) => {
        ...
        if(data.id_resep === "" || data.nama_produk === "" || data.kategori === "" || data.harga === 0 || data.deskripsi_produk === "" || data.gambar_produk === null) {
    ...
    return (
        <div className='w-screen min-h-screen p-4 overflow-y-auto'>
            <div className="flex items-center">
                <h1 className="text-4xl text-[#d08854] font-semibold">Tambah Produk Atma Kitchen</h1>
                                ...
                                <form onSubmit={handleSubmit} id="createPembelianForm" className="form-control h-full w-3/4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="w-full">
                                            <select name="id_resep" defaultValue={"Pilih Resep"} id="resep" className="select select-bordered w-full bg-white" onChange={handleChange}>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="w-full">
                                            <select name="kategori" defaultValue={"Pilih Kategori"} id="kategori" className="select select-bordered w-full bg-white" onChange={handleChange}>
...
export default CreateAtmaProdukPage;