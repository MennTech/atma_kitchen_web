...
import { DeletePengeluaranLain } from "../../../api/PengeluaranLain";
    ...
    <button className="btn btn-sm btn-outline bg-red-500 text-white" onClick={handleShow}>
      ...
      <dialog className="modal  bg-black bg-opacity-30" open={showModal}>
        <div className="bg-white p-5 rounded-lg">
          <h1 className="text-2xl font-semibold text-center">Delete Pengeluaran Lain</h1>
          <form onSubmit={submitData}>
            <div className="text-center">
              <h3 className="p-5">Apakah anda yakin ingin menghapus pengeluaran lain ini?</h3>
              <button
                type="button"
